...
def callback_laser(msg):
    ...
    section = {
        'front': min(np.concatenate((laser_range[0:20], laser_range[340:360]))),
        'left': min(laser_range[270:310]),
        'right': min(laser_range[50:90]),
    }
...
def bug_action():
    ...
    b = 0.30  # maximum threshold distance
    a = 0.40  # minimum threshold distance
