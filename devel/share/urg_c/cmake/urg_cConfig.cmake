...
if("TRUE" STREQUAL "TRUE")
  set(urg_c_SOURCE_PREFIX /home/nion/cog_rob_project/src/urg_c)
  set(urg_c_DEVEL_PREFIX /home/nion/cog_rob_project/devel)
  set(urg_c_INSTALL_PREFIX "")
  set(urg_c_PREFIX ${urg_c_DEVEL_PREFIX})
else()
  set(urg_c_SOURCE_PREFIX "")
  set(urg_c_DEVEL_PREFIX "")
  set(urg_c_INSTALL_PREFIX /home/nion/cog_rob_project/install)
...
if(NOT "/home/nion/cog_rob_project/src/urg_c/current/include " STREQUAL " ")
  set(urg_c_INCLUDE_DIRS "")
  set(_include_dirs "/home/nion/cog_rob_project/src/urg_c/current/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nion/cog_rob_project/src/urg_c/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT urg_c_NUM_DUMMY_TARGETS)
      set(urg_c_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::urg_c::wrapped-linker-option${urg_c_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR urg_c_NUM_DUMMY_TARGETS "${urg_c_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::urg_c::wrapped-linker-option${urg_c_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND urg_c_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(urg_c_EXPORTED_TARGETS ${${urg_c_dep}_EXPORTED_TARGETS})
endforeach()
