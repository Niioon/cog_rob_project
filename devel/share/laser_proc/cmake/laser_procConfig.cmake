...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/nion/cog_rob_project/src/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/nion/cog_rob_project/devel)
  ...
  set(laser_proc_INSTALL_PREFIX /home/nion/cog_rob_project/install)
...
if(NOT "/home/nion/cog_rob_project/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/nion/cog_rob_project/src/laser_proc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nion/cog_rob_project/src/laser_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT laser_proc_NUM_DUMMY_TARGETS)
      set(laser_proc_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::laser_proc::wrapped-linker-option${laser_proc_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR laser_proc_NUM_DUMMY_TARGETS "${laser_proc_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::laser_proc::wrapped-linker-option${laser_proc_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND laser_proc_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(laser_proc_EXPORTED_TARGETS ${${laser_proc_dep}_EXPORTED_TARGETS})
endforeach()
